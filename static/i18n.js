...
const LOCALES = {
  en: {
    ...
    graphs_no_repos: 'No graph repositories found.',
    graphs_no_repos_hint: 'Index a repository to see its knowledge graph here.',
    graphs_top_nodes: 'Top ranked nodes',
    graphs_suggestions: 'Suggested questions',
    graphs_ask: 'Ask a question',
    graphs_query_placeholder: 'Ask about this graph...',
    graphs_send: 'Send query',
    graphs_querying: 'Querying graph\u2026',
    graphs_error: 'Query failed: ',
    graphs_no_results: 'No results found.',
    graphs_sources: 'Sources',
    graphs_nodes: (n) => `${n} nodes`,
    graphs_edges: (n) => `${n} edges`,
    graphs_communities: (n) => `${n} communities`,
    graphs_last_updated: 'Updated',
    back: 'Back',
    ...
    cron_section_agent_jobs: 'Agent jobs',
    cron_section_launchd_jobs: 'launchd jobs',
    new_job: 'New job',
    loading: 'Loading...',
    ...
    launchd_label: 'Label',
    launchd_schedule: 'Schedule',
    launchd_pid: 'PID',
    launchd_stdout: 'stdout',
    launchd_stderr: 'stderr',
    launchd_details: 'launchd details',
    launchd_working_dir: 'Working dir',
    launchd_program: 'Program',
    launchd_last_exit: 'Last exit',
    launchd_not_loaded: 'not loaded',
    cron_status_off: 'off',
  ...
  es: {
    ...
    tab_todos: 'Todos',
    tab_graphs: 'Grafos',
    graphs_title: 'Grafos de conocimiento',
    graphs_no_repos: 'No se encontraron repositorios de grafos.',
    graphs_no_repos_hint: 'Indexa un repositorio para ver su grafo de conocimiento aqu\u00ed.',
    graphs_top_nodes: 'Nodos principales',
    graphs_suggestions: 'Preguntas sugeridas',
    graphs_ask: 'Hacer una pregunta',
    graphs_query_placeholder: 'Pregunta sobre este grafo...',
    graphs_send: 'Enviar consulta',
    graphs_querying: 'Consultando grafo\u2026',
    graphs_error: 'Consulta fallida: ',
    graphs_no_results: 'Sin resultados.',
    graphs_sources: 'Fuentes',
    graphs_nodes: (n) => `${n} nodos`,
    graphs_edges: (n) => `${n} aristas`,
    graphs_communities: (n) => `${n} comunidades`,
    graphs_last_updated: 'Actualizado',
    back: 'Volver',
